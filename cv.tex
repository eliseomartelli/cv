...
\resumeItem{Researcher \& Software Developer}{2024 -- 2026}{Consortium GARR}{Rome, Italy}{
    \item Developed a Reproducible Bioinformatics Environment Platform and a distributed computation platforn in Go.
    \item Architected an annotation library to automate code conversion for Fully Homomorphic Encryption (FHE) calculations.
...
\resumeItem{Software Developer}{2024}{Federazione Gomma Plastica}{Milan, Italy}{
    ...
    \item Jetpack Compose \& local SQLite store for offline functionality.
...
\textbf{Other:} & Visual storytelling, graphic content creation, documentary photography. 
\end{tabular}
