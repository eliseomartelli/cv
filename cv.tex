...
\resumeItem{Researcher \& Software Developer}{2024 -- 2026}{Consortium GARR}{Rome, Italy}{
    ...
    \item Produced an extensive ecosystem of tools and toolsets for zero-knowledge analysis.
    \item Responsible for Quality Assurance \& Testing.
}

\resumeItem{Software Developer}{2024}{Federazione Gomma Plastica}{Milan, Italy}{
    \item Fullstack application development for Law Enforcement agencies.
    \item Built an Android Application, Authentication Platform, and Management Web Application.
...
\resumeItem{Independent Fullstack Developer}{2014 -- 2024}{}{}{
    \item Developing and testing projects for third-party clients.
}
